...
export default function GoogleIcon({ w = 20, h = 20, className }: IconProps) {
    return (
        <svg width={w} height={h} className={className} viewBox="0 0 18 19" fill='none' xmlns='http://www.w3.org/2000/svg'>
            <g id='google'>
                <path
                    id='vector'
